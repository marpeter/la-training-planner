<?php
  ...
  class DisciplineReader extends AbstractTableReaderCSV {
  ...
  class ExerciseReader extends AbstractTableReaderCSV {
  ...
  class FavoriteReader extends AbstractTableReaderCSV {
